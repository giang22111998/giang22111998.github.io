...
@section('content')
    <section class="content-header">
        <h1>
            Thêm mới Banner <a href="{{route('admin.banner.index')}}" class="btn btn-flat btn-success pull-right "><i
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        ...
                                        <option value="5">Banner quảng cáo</option>
                                    </select>
                                    @if ($errors->has('type'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="position" name="position" value="" placeholder="0">
