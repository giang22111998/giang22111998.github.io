                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    <button  class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 ">
                                        <a title="Add to cart" href="{{ route('shop.cart.add-to-cart', ['id' => $product->id]) }}" class="btn btn-black py-3 px-5">
                                            Thêm vào giỏ hàng</a>
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img style=" display: inline-block; text-align: center; height: 310px; width: 300px;max-width: 100%; max-height: 100%;"
                                     src="{{asset($relatedProducts->image)}}" alt="IMG-PRODUCT">

                                <a href="{{route('shop.product',['slug' =>$relatedProducts->slug,'id'=>$relatedProducts->id])}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-0">
                                    Chi tiết
                                </a>
                            </div>
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        {{\Illuminate\Support\Str::limit($relatedProducts->name,60)}}
                                    </a>

                                    <span class="stext-105 cl3">
									{{number_format($relatedProducts->sale,0,",",".")}} VNĐ
								</span>
                                </div>
